...
st.subheader("Llama 3.2 90B Chatbot")

st.markdown("Built by [Build Fast with AI](https://www.buildfastwithai.com/genai-course)")

with st.sidebar:
    st.title("Llama 3.2 90B Chatbot")
    st.subheader("This app lets you chat with Llama 3.2 90B! [👉]")
...
if api_key:
    ...
    st.warning("Please enter your Groq API Key in the sidebar to start the chat.")
